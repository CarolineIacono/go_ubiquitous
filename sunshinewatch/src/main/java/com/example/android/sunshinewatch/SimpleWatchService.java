...
//
//public class SimpleWatchService extends CanvasWatchFaceService {
//
...
//
//            setWatchFaceStyle(new WatchFaceStyle.Builder(DigitalWatchActivity.this)
...
//
//            watchFace = SimpleWatchFace.newInstance(DigitalWatchActivity.this);
//            googleApiClient = new GoogleApiClient.Builder(DigitalWatchActivity.this)
//                    .addApi(Wearable.API)
